...
alex_table = Data.Array.listArray (0 :: Int, 2958)
  [ 0
  , 34
  , 34
  , 34
...
alex_check = Data.Array.listArray (0 :: Int, 2958)
  [ -1
  , 0
  , 1
  , 2
...
alex_action_8 = \pos _ -> Token pos ASSIGN
alex_action_9 = \pos _ -> Token pos PLUSFLOAT
alex_action_10 = \pos _ -> Token pos PLUSINT
alex_action_11 = \pos _ -> Token pos LET
alex_action_12 = \pos _ -> Token pos IN
alex_action_13 = \pos _ -> Token pos TYFLOAT
alex_action_14 = \pos _ -> Token pos TYINT
alex_action_15 = \pos s -> Token pos (TMFLOAT (read s))
alex_action_16 = \pos s -> Token pos (TMINT (read s))
alex_action_17 = \pos s -> Token pos $ IDLower s
alex_action_18 = \pos s -> Token pos $ IDUpper s
alex_action_19 = \pos _ -> Token pos DOT
alex_action_20 = \pos s -> Token pos $ ERROR ("Lexing error: " ++ s)
