...
alex_base = Data.Array.listArray (0 :: Int, 43)
  [ 1
  , 0
  , 0
  , 67
...
alex_table = Data.Array.listArray (0 :: Int, 955)
  [ 0
  , 18
  , 18
  , 18
...
alex_check = Data.Array.listArray (0 :: Int, 955)
  [ -1
  , 0
  , 1
  , 2
...
alex_deflt = Data.Array.listArray (0 :: Int, 43)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 43)
  [ AlexAccNone
  , AlexAcc 23
  , AlexAcc 22
  , AlexAcc 21
...
alex_action_2 = \pos _ -> Token pos TYINT
alex_action_3 = \pos _ -> Token pos TYFLOAT
alex_action_4 = \pos _ -> Token pos TYTOP
alex_action_5 = \pos _ -> Token pos ASSIGN
alex_action_6 = \pos _ -> Token pos ANDSYM
alex_action_7 = \pos _ -> Token pos PLUS
alex_action_8 = \pos _ -> Token pos COMMA
alex_action_9 = \pos _ -> Token pos COLON
alex_action_10 = \pos _ -> Token pos LPAREN
alex_action_11 = \pos _ -> Token pos RPAREN
alex_action_12 = \pos _ -> Token pos LBRACK
alex_action_13 = \pos _ -> Token pos RBRACK
alex_action_14 = \pos _ -> Token pos ARROW
alex_action_15 = \pos s -> Token pos (TMFLOAT (read s))
alex_action_16 = \pos s -> Token pos (TMINT (read s))
alex_action_17 = \pos s -> Token pos (ID s)
alex_action_18 = \pos _ -> Token pos DOT
alex_action_19 = \pos s -> Token pos (ERROR ("Lexing error: " ++ s))
