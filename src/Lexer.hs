...
alex_base = Data.Array.listArray (0 :: Int, 53)
  [ 1
  , 207
  , 233
  , 0
...
alex_table = Data.Array.listArray (0 :: Int, 2434)
  [ 0
  , 26
  , 26
  , 26
...
alex_check = Data.Array.listArray (0 :: Int, 2434)
  [ -1
  , 0
  , 1
  , 2
...
alex_deflt = Data.Array.listArray (0 :: Int, 53)
  [ -1
  , -1
  , -1
  , -1
...
alex_actions = Data.Array.array (0 :: Int, 39)
  [ (38,alex_action_3)
  , (37,alex_action_3)
  , (36,alex_action_3)
  , (35,alex_action_4)
...
alex_action_5 = \pos _ -> Token pos DOT
alex_action_6 = \pos _ -> Token pos COLON
alex_action_7 = \pos _ -> Token pos LPAREN
alex_action_8 = \pos _ -> Token pos RPAREN
alex_action_9 = \pos _ -> Token pos TYINT
alex_action_10 = \pos s -> Token pos (TMINT (read s))
alex_action_11 = \pos s -> Token pos $ IDLower s
alex_action_12 = \pos s -> Token pos $ IDUpper s
alex_action_13 = \pos s -> Token pos $ ERROR ("Lexing error: " ++ s)
