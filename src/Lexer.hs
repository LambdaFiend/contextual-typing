...
alex_base = Data.Array.listArray (0 :: Int, 110)
  [ 1
  , 207
  , 5
  , 0
...
alex_table = Data.Array.listArray (0 :: Int, 4524)
  [ 0
  , 55
  , 55
  , 55
...
alex_check = Data.Array.listArray (0 :: Int, 4524)
  [ -1
  , 0
  , 1
  , 2
...
alex_deflt = Data.Array.listArray (0 :: Int, 110)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 110)
  [ AlexAccNone
  , AlexAcc 94
  , AlexAcc 93
  , AlexAcc 92
...
alex_actions = Data.Array.array (0 :: Int, 95)
  [ (94,alex_action_14)
  , (93,alex_action_38)
  , (92,alex_action_13)
  , (91,alex_action_38)
...
alex_action_1 = \pos _ -> Token pos FST
alex_action_2 = \pos _ -> Token pos SND
alex_action_3 = \pos _ -> Token pos LAMBDA
alex_action_4 = \pos _ -> Token pos ARROW
alex_action_5 = \pos _ -> Token pos FORALL
alex_action_6 = \pos _ -> Token pos APPLY
...
alex_action_11 = \pos _ -> Token pos ASSIGN
alex_action_12 = \pos _ -> Token pos AND
alex_action_13 = \pos _ -> Token pos OR
alex_action_14 = \pos _ -> Token pos NOT
alex_action_15 = \pos _ -> Token pos PLUSFLOAT
alex_action_16 = \pos _ -> Token pos PLUSINT
alex_action_17 = \pos _ -> Token pos MINUSFLOAT
alex_action_18 = \pos _ -> Token pos MINUSINT
alex_action_19 = \pos _ -> Token pos MULTFLOAT
alex_action_20 = \pos _ -> Token pos MULTINT
alex_action_21 = \pos _ -> Token pos DIVFLOAT
alex_action_22 = \pos _ -> Token pos DIVINT
alex_action_23 = \pos _ -> Token pos LET
alex_action_24 = \pos _ -> Token pos IN
alex_action_25 = \pos _ -> Token pos TYFLOAT
alex_action_26 = \pos _ -> Token pos TYINT
alex_action_27 = \pos _ -> Token pos TYBOOL
alex_action_28 = \pos _ -> Token pos TRUE
alex_action_29 = \pos _ -> Token pos FALSE
alex_action_30 = \pos _ -> Token pos IF
alex_action_31 = \pos _ -> Token pos THEN
alex_action_32 = \pos _ -> Token pos ELSE
alex_action_33 = \pos s -> Token pos (TMFLOAT (read s))
alex_action_34 = \pos s -> Token pos (TMINT (read s))
alex_action_35 = \pos s -> Token pos $ IDLower s
alex_action_36 = \pos s -> Token pos $ IDUpper s
alex_action_37 = \pos _ -> Token pos DOT
alex_action_38 = \pos s -> Token pos $ ERROR ("Lexing error: " ++ s)
