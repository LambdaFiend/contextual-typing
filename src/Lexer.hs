...
alex_table = Data.Array.listArray (0 :: Int, 4802)
  [ 0
  , 57
  , 57
  , 57
...
alex_check = Data.Array.listArray (0 :: Int, 4802)
  [ -1
  , 0
  , 1
  , 2
...
alex_actions = Data.Array.array (0 :: Int, 99)
  [ (98,alex_action_16)
  , (97,alex_action_17)
  , (96,alex_action_18)
  , (95,alex_action_19)
...
alex_action_28 = \pos _ -> Token pos TYUNIT
alex_action_29 = \pos _ -> Token pos TRUE
alex_action_30 = \pos _ -> Token pos FALSE
alex_action_31 = \pos _ -> Token pos IF
alex_action_32 = \pos _ -> Token pos THEN
alex_action_33 = \pos _ -> Token pos ELSE
alex_action_34 = \pos s -> Token pos (TMFLOAT (read s))
alex_action_35 = \pos s -> Token pos (TMINT (read s))
alex_action_36 = \pos s -> Token pos $ IDLower s
alex_action_37 = \pos s -> Token pos $ IDUpper s
alex_action_38 = \pos _ -> Token pos DOT
alex_action_39 = \pos s -> Token pos $ ERROR ("Lexing error: " ++ s)
